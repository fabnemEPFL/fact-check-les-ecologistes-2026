#!/usr/bin/env python3
"""Reproduce the transparent energy-reconciliation scenarios.
...
def main():
    ...
    batches = 50  # reconstructed; see energy_estimate.json
    scenarios = {
        "low": (1, 1.5, 62, .16),
        "central": (2, 3.91, 312, 1.0),
        "high": (5, 7.05, 623, 3.6),
    }
    for name, (long_n, long_wh, continuation_n, continuation_wh) in scenarios.items():
        wh = batches * long_n * long_wh + continuation_n * continuation_wh
